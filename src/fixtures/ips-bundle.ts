/**
 * The IG's own International Patient Summary example, decrypted.
 *
 * This is the plaintext behind the first working link on the SMART Health Cards
 * and Links implementation guide's links-examples page, decrypted end to end
 * with the published example key. It is unmodified: every entry, every code and
 * every dangling reference is the IG's, so a renderer that looks right against
 * this fixture looks right against the file the specification ships.
 *
 * Two things about it are worth knowing before you use it as an oracle.
 *
 * The bundle is minified here, not reformatted. `JSON.parse` of the wire
 * plaintext (60,973 bytes) and `JSON.stringify` of this constant produce the
 * same 45,565 bytes in the same member order, so the semantics are byte-checked
 * rather than assumed; only the whitespace the server sent is gone. The
...
/**
 * A Bundle whose entries carry concrete resources.
 *
 * `@types/fhir` types `BundleEntry.resource` as the abstract `Resource`, which
 * has no `text`, no `code` and no `status`, so a literal made of real entries
 * does not typecheck against `Bundle` at all. Narrowing it to the `FhirResource`
 * union is what lets these fixtures be checked data rather than a cast: get a
 * code system name or an element name wrong and `tsc` says so.
 *
 * It lives in this module rather than in the catalogue because the catalogue
 * imports the fixtures, and a fixture importing back from the catalogue would
 * put a cycle in the graph for the sake of one type.
 */
export type FixtureBundle = Omit<Bundle, 'entry'> & {
  entry: Array<Omit<BundleEntry, 'resource'> & { fullUrl: string; resource: FhirResource }>;
};

/**
 * A FHIR document Bundle: 20 entries, first a Composition, dated 2017 by its own
 * timestamp. Note `identifier.system` is an OID (`urn:oid:2.16.724.4.8.10.200.10`)
 * rather than the `urn:ietf:rfc:3986` most Australian producers use, and there is
 * no `meta.profile` at all: this example claims no IPS conformance on the wire,
 * so a viewer that keys its layout off a profile canonical renders nothing here.
 */
export const IG_IPS_BUNDLE: FixtureBundle = {
  resourceType: 'Bundle',
  ...
  entry: [
    {
      ...
      resource: {
        ...
        text: {
          status: 'generated',
          div: '<div xmlns="http://www.w3.org/1999/xhtml"><p><b>Generated Narrative</b></p><div style="display: inline-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%"><p style="margin-bottom: 0px">Resource "30551ce1-5a28-4356-b684-1e639094ad4d" </p></div><p><b>identifier</b>: id: 3f69e0a5-2177-4540-baab-7a5d0877428f</p><p><b>status</b>: final</p><p><b>type</b>: Patient summary Document <span style="background: LightGoldenRodYellow; margin: 4px; border: 1px solid khaki"> (<a href="https://loinc.org/">LOINC</a>#60591-5)</span></p><p><b>date</b>: 2017-12-11T14:30:00+01:00</p><p><b>author</b>: <a href="#Practitioner_1c616b24-3895-48c4-9a02-9a64110351ef">See above (Practitioner/1c616b24-3895-48c4-9a02-9a64110351ef)</a></p><p><b>title</b>: Patient Summary as of December 11, 2017 14:30</p><p><b>confidentiality</b>: N</p><blockquote><p><b>attester</b></p><p><b>mode</b>: legal</p><p><b>time</b>: 2017-12-11T14:30:00+01:00</p><p><b>party</b>: <a href="#Practitioner_1c616b24-3895-48c4-9a02-9a64110351ef">See above (Practitioner/1c616b24-3895-48c4-9a02-9a64110351ef)</a></p></blockquote><blockquote><p><b>attester</b></p><p><b>mode</b>: legal</p><p><b>time</b>: 2017-12-11T14:30:00+01:00</p><p><b>party</b>: <a href="#Organization_890751f4-2924-4636-bab7-efffc7f3cf15">See above (Organization/890751f4-2924-4636-bab7-efffc7f3cf15)</a></p></blockquote><p><b>custodian</b>: <a href="#Organization_890751f4-2924-4636-bab7-efffc7f3cf15">See above (Organization/890751f4-2924-4636-bab7-efffc7f3cf15)</a></p><h3>RelatesTos</h3><table class="grid"><tr><td>-</td><td><b>Code</b></td><td><b>Target[x]</b></td></tr><tr><td>*</td><td>appends</td><td>id: c2277753-9f90-4a95-8ddb-a0b3f6e7d292</td></tr></table><h3>Events</h3><table class="grid"><tr><td>-</td><td><b>Code</b></td><td><b>Period</b></td></tr><tr><td>*</td><td>care provision <span style="background: LightGoldenRodYellow; margin: 4px; border: 1px solid khaki"> (<a href="http://terminology.hl7.org/3.0.0/CodeSystem-v3-ActClass.html">ActClass</a>#PCPR)</span></td><td>?? --&gt; 2017-12-11T14:30:00+01:00</td></tr></table></div>',
        },
        identifier: {
          system: 'urn:oid:2.16.724.4.8.10.200.10',
        ...
        attester: [
          {
            ...
            party: { reference: 'Practitioner/1c616b24-3895-48c4-9a02-9a64110351ef' },
          },
          {
            mode: 'legal',
            time: '2017-12-11T14:30:00+01:00',
            party: { reference: 'Organization/890751f4-2924-4636-bab7-efffc7f3cf15' },
          },
        ],
        ...
        event: [
          {
            code: [
              {
                coding: [
                  { system: 'http://terminology.hl7.org/CodeSystem/v3-ActClass', code: 'PCPR' },
                ],
              },
            ],
            period: { end: '2017-12-11T14:30:00+01:00' },
          },
        ],
        section: [
          {
            ...
            entry: [{ reference: 'Condition/c64139e7-f02d-409c-bf34-75e8bf23bc80' }],
          },
          {
            title: 'Medication',
            code: {
          ...
          },
          {
            ...
            code: {
              coding: [
                { system: 'http://loinc.org', code: '11348-0', display: 'Hx of Past illness' },
              ],
            },
            text: {
              status: 'generated',
            ...
            entry: [{ reference: 'Condition/c4597aa2-688a-401b-a658-70acc6de28c6' }],
          },
          {
    ...
    },
    {
      ...
      resource: {
        ...
        active: true,
        name: [{ family: 'DeLarosa', given: ['Martha'] }],
        ...
        contact: [
          {
            ...
            name: { family: 'Mum', given: ['Martha'] },
            telecom: [{ system: 'phone', value: '+33-555-20036', use: 'home' }],
            address: {
    ...
    },
    {
      ...
      resource: {
        ...
        identifier: [
          { system: 'urn:oid:1.2.3.999', value: 'c87bf51c-e53c-4bfe-b8b7-aa62bdd93002' },
        ],
        clinicalStatus: {
          coding: [
        ...
        category: [
          {
            coding: [
              ...
              { system: 'http://loinc.org', code: '75326-9', display: 'Problem' },
            ],
          },
        ],
        severity: {
          coding: [{ system: 'http://loinc.org', code: 'LA6751-7', display: 'Moderate' }],
        },
        code: {
          coding: [
            {
    ...
    },
    {
      ...
      resource: {
        ...
        identifier: [
          { system: 'urn:oid:1.2.3.999', value: 'b75f92cb-61d4-469a-9387-df5ef70d25f0' },
        ],
        status: 'active',
        ...
        dosage: [
          {
            ...
            route: {
              coding: [
                { system: 'http://standardterms.edqm.eu', code: '20053000', display: 'Oral use' },
              ],
            },
            doseAndRate: [
              {
    ...
    },
    {
      ...
      resource: {
        ...
        identifier: [
          { system: 'urn:oid:1.2.3.999', value: '9e312d6b-c6b6-439a-a730-6efaa5dcf8bc' },
        ],
        status: 'active',
      ...
      resource: {
        ...
        code: {
          coding: [
            ...
            { system: 'http://www.whocc.no/atc', code: 'L02BG03', display: 'anastrozole' },
          ],
        },
      },
    },
      ...
      resource: {
        ...
        code: {
          coding: [
            ...
            { system: 'http://www.whocc.no/atc', code: 'G02CX04', display: 'Cimicifugae rhizoma' },
          ],
    ...
    },
    {
      ...
      resource: {
        ...
        identifier: [
          { system: 'urn:oid:1.2.3.999', value: '3a462598-009c-484a-965c-d6b24a821424' },
        ],
        clinicalStatus: {
          coding: [
            {
    ...
    },
    {
      ...
      resource: {
        ...
        identifier: [
          { system: 'urn:oid:1.2.3.999', value: '66d4a8c7-9081-43e0-a63f-489c2ae6edd6' },
        ],
        clinicalStatus: {
          coding: [
            {
        ...
        severity: { coding: [{ system: 'http://loinc.org', code: 'LA6750-9', display: 'Severe' }] },
        code: {
          coding: [
            {
              system: 'http://snomed.info/sct',
    ...
    },
    {
      ...
      resource: {
        ...
        type: [
          {
            coding: [
              { system: 'http://terminology.hl7.org/CodeSystem/organization-type', code: 'other' },
            ],
          },
        ],
